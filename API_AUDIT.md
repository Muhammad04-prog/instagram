# API_AUDIT — фронтенд ↔ backend (166/190 endpoint пайваст)
...
## Ҳолати ҳозира: 24 endpoint нопайваст
...
| **music**                                                                                                     | 6/9     | 3: `/music/online/*` (провайдерҳо, ҷустуҷӯ, save)                                         | 🟡 Барои ёддошт бо мусиқии беруна                                              |
...
1. **socket + chats/calls** (12 endpoint) — калонтарин ва мураккабтарин пора: `socket.io-client`,
...
2. **music/online** (3) — ҷустуҷӯи мусиқии беруна барои ёддошт/пост.
