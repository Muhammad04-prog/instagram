...
export const ROUTES = {
  ...
  personalInfo: "/settings/personal-information",
  favorites: "/profile/favorites",
  activity: "/profile/activity",
  insights: "/profile/insights",
  storyArchive: "/stories/archive",
  addYours: (promptId: string) => `/stories/add-yours/${promptId}`,
  settings: "/settings",
  ...
  storyVisibility: "/settings/story-visibility",
  messagesSettings: "/settings/messages",
  tags: "/settings/tags",
  comments: "/settings/comments",
  sharing: "/settings/sharing",
  restrictedAccounts: "/settings/restricted",
  hiddenWords: "/settings/hidden-words",
  hiddenAccounts: "/settings/hidden-accounts",
  contentPreferences: "/settings/content-preferences",
  likeShareCounts: "/settings/like-share-counts",
  archiving: "/settings/archiving",
  drafts: "/settings/drafts",
  accessibility: "/settings/accessibility",
  language: "/settings/language",
  sitePermissions: "/settings/site-permissions",
  accountType: "/settings/account-type",
  accountStatus: "/settings/account-status",
  accountActions: "/settings/actions",
  help: "/settings/help",
  accountsCenter: "/settings/accounts-center",
} as const;
